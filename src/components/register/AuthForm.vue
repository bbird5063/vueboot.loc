      ...
      <div class="modal-dialog" role="document">
        ...
        <div
          ...
          <div class="modal-body">
            ...
            <form
              action="/modules/register/login_controller_ajax.php"
              method="post"
              id="Login-Form"
              role="form_ajax"
              for="login">
          ...
          <div class="modal-footer">
            <p>
              <a id="FPModal" href="javascript:void(0)" for="nextPage"
                >Забыли пароль?</a
              >
              |
              <a id="signupModal" href="javascript:void(0)" for="nextPage"
                >Регистрация</a
              >
            </p>
          </div>
        ...
        <div
          ...
          <div class="modal-body">
            ...
            <form
              action="/modules/register/registration_controller_ajax.php"
              method="post"
              id="Signin-Form"
              role="form_ajax"
              for="signup">
          ...
          <div class="modal-footer">
            <p>
              Имеете аккаунт?
              <a id="loginModal" href="javascript:void(0)" for="nextPage"
                >Войти в аккаунт</a
              >
            </p>
          </div>
        ...
        <div
          ...
          <div class="modal-body">
            ...
            <form
              action="/modules/register/restoration_controller_ajax.php"
              method="post"
          ...
          <div class="modal-footer">
            <p>
              Вспомнили пароль?
              <a id="loginModal1" href="javascript:void(0)" for="nextPage"
                >Войти в аккаунт</a
              >
            </p>
            <p>
              Ваши личные данные:
              <a id="userModal" href="javascript:void(0)" for="nextPage"
                >ваш профиль</a
              >
            </p>
          </div>
        ...
        <div
          ...
          <div class="modal-body">
            ...
            <form
              action="/modules/register/activate_controller_ajax.php"
              method="post"
              id="Code-Form"
              role="form_ajax"
              for="code">
          ...
          <div class="modal-footer">
            <p>
              <a id="FPModal1" href="javascript:void(0)" for="nextPage"
                >Забыли пароль?</a
              >
              |
              <a id="signupModal1" href="javascript:void(0)" for="nextPage"
                >Регистрация</a
              >
            </p>
          </div>
        ...
        <div
          ...
          <div class="modal-body">
            <div id="Signin-Form-Error" for="error"></div>
            <form
              action="/modules/register/new_pw_controller_ajax.php"
              method="post"
              id="Signin-Form"
              role="form_ajax"
              for="password">
        ...
        <div
          ...
          <div class="modal-body">
            ...
            <form
              action="/modules/register/user_controller_ajax.php"
              method="post"
              id="User-Form"
              role="form_ajax"
              for="user">
          ...
          <div class="modal-footer">
            <p>
              Имеете аккаунт?
              <a id="FPModal2" href="javascript:void(0)" for="nextPage"
                >Изменить пароль?</a
              >
            </p>
          </div>
        ...
        <div
          ...
          <div class="modal-body">
            ...
            <form
              action="/modules/register/exit_controller_ajax.php"
              method="post"
              id="Exit-Form"
              role="form_ajax"
              for="exit">
